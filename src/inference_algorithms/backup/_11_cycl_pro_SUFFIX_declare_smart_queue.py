                ...
                for i in range(predict_size):
                    for k in range(current_beam_size):
                        ...
                        for j in range(current_beam_size):
                            ...
                            # print 'probability_this: ' + str(probability_this)
                            ...
                            if temp_prediction == '!':
                                ...
                                temp_total_predicted_time = current_prediction_premis.total_predicted_time
                                ...
                                average_probability = temp.probability_of / len(temp_cropped_line[prefix_size:])

                                print 'INFORMATION: ' + str(counterr) + ' ' + str(i) + ' ' + str(k) + ' ' + \
                                      str(j) + ' ' + temp_cropped_line[prefix_size:] + "     " + ground_truth + \
                                      "     " + temp_cropped_line_group[prefix_size:] + "     " + \
                                      ground_truth_group + "     " + str(temp.probability_of)
                                if verify_with_data(path_to_declare_model_file,
                                                    current_trace_id,
                                                    temp_cropped_line,
                                                    temp_cropped_line_group,
