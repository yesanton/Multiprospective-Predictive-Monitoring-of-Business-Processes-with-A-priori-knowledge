...
def train():
    ...
    group_output = Dense(len(target_chars_group), activation='softmax', init='glorot_uniform', name='group_output')(b2_3)
    ...
    path_to_model = 'output_files/models_group/models_2' + eventlog[:-4] + '/model_{epoch:02d}-{val_loss:.2f}.h5'
