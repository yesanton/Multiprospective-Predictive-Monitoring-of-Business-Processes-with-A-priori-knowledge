...
def activateSettings(logNumber, formulaType):
    ...
    #     median = 4
        ...
        path_to_model_file = '/home/kaur/Documents/FBK/Process-Sequence-Prediction-with-A-priori-knowledge-master/src/output_files/models_helpdesk_mini/model_49-1.47.h5'
        median = 4
        if formulaType == "STRONG":
            formula= " []( ( \"8\" -> <>( \"6\" ) ) ) /\ <>\"8\"" #"[]( ( \"1\" -> <>( \"8\" ) ) )  /\ <>\"1\" "# /\
        if formulaType == "WEAK":
...
eventlog = "bpi_14_detail_incident_extra.csv"
path_to_model_file = '/home/kaur/Documents/FBK/Process-Sequence-Prediction-with-A-priori-knowledge-master/src/output_files/models/model.h5'
